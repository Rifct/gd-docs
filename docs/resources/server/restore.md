...
`Restore` was a feature used in Geometry dash from versions `1.7 - 2.0` and it was used as an alternative to the Account System that is currently used as of 2.206
