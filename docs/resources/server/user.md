...
| 7   | accountHighlight    | **Integer** | The player's Account ID. Used for highlighting the player on the leaderboards                                                                                                                               |
...
| 15  | special             | **Integer** | The player's special number. If accGlow = 1, special = 2; if accGlow = 0, special = 0.                                                                                                                      |
