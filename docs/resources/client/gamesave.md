...
| playerFrame                                                | [Player Icon](/resources/client/enumerations.md#player-icon)            | The ID of the player's cube                                                         |
| playerShip                                                 | [Player Ship](/resources/client/enumerations.md#player-ship)            | The ID of the player's ship                                                         |
| playerBall                                                 | [Player Ball](/resources/client/enumerations.md#player-ball)            | The ID of the player's ball                                                         |
| playerBird                                                 | [Player UFO](/resources/client/enumerations.md#player-ufo)             | The ID of the player's UFO                                                          |
| playerDart                                                 | [Player Wave](/resources/client/enumerations.md#player-wave)            | The ID of the player's wave                                                         |
| playerRobot                                                | [Player Robot](/resources/client/enumerations.md#player-robot)           | The ID of the player's robot                                                        |
| playerSpider                                               | [Player Spider](/resources/client/enumerations.md#player-spider)          | The ID of the player's spider                                                       |
| playerSwing                                                | [Player Swing](/resources/client/enumerations.md#player-swing)           | The ID of the player's swing                                                        |
| playerColor                                                | [Primary Player Color](/resources/client/enumerations.md#primary-player-color)   | The ID of the player's primary color                                                |
| playerColor2                                               | [Secondary Player Color](/resources/client/enumerations.md#secondary-player-color) | The ID of the player's secondary color                                              |
| playerColor3                                               | [Glow Player Color](/resources/client/enumerations.md#glow-player-color)      | The ID of the player's glow color, -1 if same as secondary color                    |
| playerStreak                                               | [Player Trail](/resources/client/enumerations.md#player-trail)           | The ID of the player's trail                                                        |
| playerShipStreak                                           | [Player Streak](/resources/client/enumerations.md#player-streak)          | The ID of the player's ship streak                                                  |
| playerDeathEffect                                          | [Player Death Effect](/resources/client/enumerations.md#player-death-effect)    | The ID of the player's death effect                                                 |
| playerJetpack                                              | [Player Jetpack](/resources/client/enumerations.md#player-jetpack)         | The ID of the player's jetpack                                                      |
| playerIconType                                             | [Player Icon Type](/resources/client/enumerations.md#player-icon-type)       | The Index of the player's IconType                                                  |
...
| resolution                                                 | [Resolution](/resources/client/enumerations.md#resolution)                                 | The games resolution                                                                |
| texQuality                                                 | [Texture Quality](/resources/client/enumerations.md#texture-quality)                                                                           | how high the text quality is (0 for Auto, 1 for Low, 2 for Medium and 3 for High)   |
