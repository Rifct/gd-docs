...
| --- | ---------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| `1` | Type       | [Quest Type](/resources/client/enumerations.md#quest-type)         | This is used to diffrenciate the type of quest needs to be completed: 1 = Orbs, 2 = Coins, 3 = Stars |
...
| `8` | Position   | [Quest Position](/resources/client/enumerations.md#quest-position) | Where abouts on screen the quest should be                                                           |