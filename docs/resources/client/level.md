...
| k23  | Length                                                                   | **[Level Length](/resources/client/enumerations.md#level-length)** | the level's length                                                               |
...
| k87  | level Seed                                                               | **[LevelScoreSeed](/topics/encryption/chk.md#level-leaderboard)**                      | Contains info to verify the integrity of levelScores                             |
