...
| `kA2`  | Gamemode                 | **[Gamemode](/resources/client/enumerations#gamemode)**       | the gamemode the player starts with                                                                                           |
| `kA3`  | Mini Mode                | **bool**                                                                       | determines whether the player starts off as mini Mode                                                                         |
| `kA4`  | Speed                    | **[Speed](/resources/client/enumerations#speed)**             | the speed of the level at the start                                                                                           |
